...
class _QuizWelcomeScreenState extends State<QuizWelcomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.quizTitle, style: TextStyle(color: Colors.white)),
        centerTitle: true,
                          ...
                          Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder: (context) => QuizScreen(
                                quizId: widget
                                    .quizId, // <-- [FIX] Gunakan widget.quizId
                                quizTitle: widget
                                    .quizTitle, // <-- [FIX] Gunakan widget.quizTitle
                              ),
                            ),
                          );
                        },
